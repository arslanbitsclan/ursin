...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>appci/assets/entries/css/hw-style.css">
  <link rel="stylesheet" href="<?php echo base_url(); ?>appci/assets/entries/css/subhome.css" >
  ...
  {scripts}
   <?php if($this->session->flashdata('success')) { ?>
    ...
    <?php } ?>
<script src="<?php echo base_url(); ?>appci/assets/entries/js/show_homework/selector.js"></script>
