...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>appci/assets/entries/css/exm-style.css">
...
<link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/daterangepicker/daterangepicker.css" />
  ...
  {scripts}
   <?php if($this->session->flashdata('success')) { ?>
    ...
    <?php } ?>
<script src="<?php echo base_url(); ?>appci/assets/entries/js/exams/selector.js"></script>
