...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>appci/assets/entries/css/absent-style.css">
  ...
  {scripts}
   <?php if($this->session->flashdata('success')) { ?>
    ...
    <?php } ?>
<script src="<?php echo base_url(); ?>appci/assets/entries/js/absent/selector.js"></script>
